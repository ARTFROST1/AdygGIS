...
- ✗ `Docs/Markers/markers_update/` - 12 MD файлов с историей разработки (не нужны в production)
- ✗ `Docs/Optimization/Data_optimization/` - 6 MD файлов с техническими деталями
...
- [ ] Переместить `Docs/Markers/markers_update/` в архив
- [ ] Переместить `Docs/Optimization/Data_optimization/` в архив
