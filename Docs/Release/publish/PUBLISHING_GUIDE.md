...
**Текущий статус:** Функционально реализовано (MVP + расширения) ✅; публикация требует внешних шагов (Play Console, материалы, проверка release-signing)  
...
- 🔐 **Release signing configuration** (проверить локально: заполнен `keystore.properties`, доступен keystore, собирается release/AAB)
