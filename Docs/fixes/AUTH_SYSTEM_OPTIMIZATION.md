# Auth System Optimization Report - AdygGIS-KT
...
Проведена полная оптимизация системы авторизации в Android-приложении AdygGIS-KT по лучшим практикам безопасности и UX. Система переведена с небезопасного хранения токенов на зашифрованное хранение с автоматическим обновлением токенов и улучшенным пользовательским интерфейсом.
